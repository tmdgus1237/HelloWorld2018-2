...
if opts.enableCudnn
  ...
  switch arch
    case 'win64', opts.cudnnLibDir = fullfile(opts.cudnnRoot, 'lib64') ;
...
cl_path = fullfile(cc.Location, 'VC','Tools','MSVC','14.13.26128', 'bin', 'Hostx64','x64');
...
for v = {'5.5', '6.0', '6.5', '7.0', '7.5', '8.0', '8.5', '9.0', '10.0'}
  switch computer('arch')
    case 'glnxa64'
